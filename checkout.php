...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-lg6 px-4 pb-4" id="order">
			<h4 class="text-center text-info p-2">Complete Your Order!</h4>
			<div class="jumbotron p-3 mb-2 text-center">
				<h6 class="lead"><b>Product(s) : </b><?= $allItems; ?></h6>
				<h5><b>Total Amount Payable : <i class="fas fa-rupee-sign"></i></b>&nbsp;&nbsp;<?= number_format($grand_total,2) ?>/-</h5>
			</div>
			<form action="" method="post" id="placeOrder">
				...
				<div class="form-group">
					<textarea name="address" class="form-control" rows="3" cols="10" placeholder="Enter Delivery Address Here..">
